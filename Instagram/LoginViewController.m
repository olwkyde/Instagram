...
- (void)loginUser {
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Invalid Sign Up"  message:@"Wrong username or passwordrckjbjudvrgunt" preferredStyle:(UIAlertControllerStyleAlert)];
